...
.. raw:: html
 ...
 <li><span class="li-head">notificationType</span> Integer representing how notifications should be handled on FortiSandbox file submission. 0 - display notification balloon when malware is detected in a submission. 1 - display a popup for all file submissions.<span class="li-normal">type: raw</span><span class="li-normal">choices: ['0', '1']</span></li>
